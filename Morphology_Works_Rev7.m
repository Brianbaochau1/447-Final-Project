%%% 447 Cartoonization Project - Revision 7 (11/14/2024)
%%% (This Code below works Really Well) %%
%%% Using Morphology and Boundary Masking
...
title('Image with Expanded Color Variation');